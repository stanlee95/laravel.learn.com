@extends('layouts.admin')
    ...
    @section('content')
        <form method="post" action="/" enctype="multipart/form-data">
            {!! csrf_field() !!}
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="margin-left: 150px;color: black">
            ...
            <div class="panel panel-default">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                        <div class="panel-body">
                            @foreach($users as $user)
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <input type="radio" name="name" value="{{$user->name}}">
                                    </span>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <b>Upload images:</b>
                            <input class="form-control" type="file" name="photo[]" accept="image/*,image/jpeg" multiple size="4"><br>
                            <b>Upload files:</b>
