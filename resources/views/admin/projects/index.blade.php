    ...
    <div class="row">
        <div class="col-xs-16">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg"
                    onclick="getProjectById(null)">
                <a href="#" style="color: white">CreateProject</a>
            </button>
        </div>
        @foreach($projects as $project)
        <div id="project-div-{{$project->project_id}}">
                ...
                <div class="media-body">
                    ...
                    <blockquote>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target=".bs-example-modal-lg" onclick="getProjectById({{$project->project_id}})">
                            <a href="#"  style="color: white">Update</a>
                        </button>
                        <button type="button" class="btn btn-primary" onclick="projectDelete({{$project->project_id}})">
                                Delete
                        </button>
                    </blockquote>
                </div>
        ...
        <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="color: black;">
                    ...
                    <input type="text" id="title" class="form-control" name="title" placeholder="Insert New Title"
                           required>
                    <br>
                    <input type="text" id="software" class="form-control" name="software"
                           placeholder="Insert Software Requirements">
                    <br>
                    <input type="text" id="literature" class="form-control" name="literature"
                           placeholder="Insert Literature">
                    <br>
                    <div>
                        <h2>Insert Description:</h2>
                        <textarea name="content_full" id="content" rows="10" cols="100" required autofocus></textarea>
                    </div>
                    <div class="col-lg-6">
